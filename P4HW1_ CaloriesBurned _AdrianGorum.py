...
def main():
    ...
    #Inform the user of what the program is doing
    print("This program will display calories burned after 25 minutes, 35 minutes,",
          "\n& 45 minutes, if 5 calories were burned per minute.\n")
