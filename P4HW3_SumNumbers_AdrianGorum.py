...
#Pseudocode
#>Initialize a varible of user_num
#>Gather input from user
#>Initialize a sum_total varible
#>Use a while loop to check and see if the user inputed value is greater than 0
#>Calculate a sum_total using user inputed value
#>Display sum_total once while loop ends
...
def main():
    ...
    #Initialize total variable; this is the accumulator
    sum_total = 0
